// Open mobile MENU
const left__menu = document.querySelector(".left-menu");
const ham = document.querySelector(".hamburger");

ham.addEventListener('click', () => {
  left__menu.style.left = "0px";
});

// close mobile menu
const closeBtn = document.querySelector(".close-btn");
closeBtn.addEventListener('click', () => {
  left__menu.style.left = "-300px";
})
...
// desktop card view
const singleItemCard = document.querySelector('.single-item-card');
const fullSingleCardArea = document.querySelector('.full-single-card-area');
